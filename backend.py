...
FULL_YOLO_BACKEND_PATH  = "backend/full_yolo_backend.h5"   # should be hosted on a server
TINY_YOLO_BACKEND_PATH  = "backend/tiny_yolo_backend.h5"   # should be hosted on a server
SQUEEZENET_BACKEND_PATH = "backend/squeezenet_backend.h5"  # should be hosted on a server
MOBILENET_BACKEND_PATH  = "backend/mobilenet_backend.h5"   # should be hosted on a server
INCEPTION3_BACKEND_PATH = "backend/inception_backend.h5"   # should be hosted on a server
VGG16_BACKEND_PATH      = "backend/vgg16_backend.h5"       # should be hosted on a server
RESNET50_BACKEND_PATH   = "backend/resnet50_backend.h5"    # should be hosted on a server
