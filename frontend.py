...
class YOLO(object):
    ...
    def predict(self, image, obj_threshold=0.3, nms_threshold=0.3):
        ...
        boxes  = self.decode_netout(netout, obj_threshold=obj_threshold, nms_threshold=nms_threshold)
    ...
    def bbox_iou(box1, box2):
        ...
        intersect_w = YOLO.interval_overlap([x1_min, x1_max], [x2_min, x2_max])
        intersect_h = YOLO.interval_overlap([y1_min, y1_max], [y2_min, y2_max])
